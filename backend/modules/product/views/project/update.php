                ...
                <div id="thumbpic-content" class="layout-content" aria-disabled="false" aria-pressed="false" >
                    <?php if(!empty($project['pic'])): ?>
                        <div id="" class=" pull-left img-content-li">
                            <a href="javaScript:;"><span class="label label-important img-delete" file-path="<?php echo $project['pic'] ?>">删除</span></a>
                            <div aria-disabled="false"  class="" aria-pressed="false">
                                <img  src="<?php echo $project['pic'] ?>" />
                                <input type="hidden" name="pic" value="<?php echo $project['pic'] ?>">
                                <p></p>
                            </div>
                        </div>
                    <?php endif ?>
        ...
        BUI.use('bui/form',function(Form){
            ...
            $("#save-case").on('click', function(){
                if(form.isValid()){
                    ...
                    $._ajax('/product/project/update', $("#Goods_Form").serialize(), 'POST', 'JSON', function(json){
                        if(json.code > 0){
    ...
    <script>
        $(function () {
            ...
            editor.ready(function(){
                editor.setContent('<?php echo $project['detail'] ?>');
            });
        })
