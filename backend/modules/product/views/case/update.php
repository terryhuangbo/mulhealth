...
<form id="Goods_Form" action="" class="form-horizontal" onsubmit="return false;" >
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="tags" type="text" class="input-medium" data-rules="{number:true, required : true}" value="<?php echo $case['tags'] ?>">
        </div>
    </div>
    ...
    <div class="row" >
        <div class="span16 layout-outer-content">
            <div id="thumbpic-content" class="layout-content" aria-disabled="false" aria-pressed="false" >
                <?php if(!empty($case['pic'])): ?>
                    <div id="" class=" pull-left img-content-li">
                        <a href="javaScript:;"><span class="label label-important img-delete" file-path="<?php echo $case['pic'] ?>">删除</span></a>
                        <div aria-disabled="false"  class="" aria-pressed="false">
                            <img  src="<?php echo $case['pic'] ?>" />
                            <input type="hidden" name="pic" value="<?php echo $case['pic'] ?>">
                            <p></p>
                        </div>
                    </div>
                <?php endif ?>
