...
<head>
    ...
    <script>
        _BASE_LIST_URL =  "<?php echo yiiUrl('report/report/list') ?>";
    </script>
</head>
    ...
    $(function () {
        ...
        BUI.use(['bui/grid', 'bui/data'], function (Grid, Data) {
            ...
            var store = new Data.Store({
                ...
                root: 'reportList',//数据返回字段,支持深成次属性root : 'data.records',
...
<script>
    ...
    function searchCases() {
        ...
        var store = $("#report_grid").data("BGrid").get('store');
    ...
    function ajax_change_status(id, status, callback){
        var param = param || {};
        param.id = id;
        param.report_status = status;
        $._ajax('<?php echo yiiUrl('report/report/ajax-change-status') ?>', param, 'POST','JSON', function(json){
